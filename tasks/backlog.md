...
- Run the explicit PSpec Stack/OrderedMap author tasks with an eligible uninvolved
  ...
  truthfully. This post-open convergence item remains required before ExecPlan 0006
  closes or its PR merges; a failed task reopens the smallest affected design-spec or
...
- ExecPlan 0001 completed strict records, deterministic local loading, the Stack
  reference boundary, one bounded Lean proof, Rust and TypeScript Realizations, shared
  campaign controls, and declaration-scoped Evidence.
...
- [ExecPlan 0005](../docs/exec-plans/completed/0005-deployment-profile-choice.md)
  completed the exact deployment-profile tracer: fresh
